...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/Infomedia Basemap.gexf', 'utf8');
...
settings.margin_top    = 56 // in mm
settings.margin_right  = 168 // in mm
settings.margin_bottom = 8 // in mm
settings.margin_left   = 216 // in mm
...
settings.heatmap_spreading = settings.image_width / 150 // in mm
...
g.nodes().forEach(nid => {
  ...
  n.showLabel = n.type == "ORG" || n.type == "PER"
})
