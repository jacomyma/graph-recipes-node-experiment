...
const filename = "0400 Black dots + labels"
...
settings.node_stroke_width = 0.1
...
newRenderer = function(){
  ...
  ns.drawNodeLabelsLayer = function(options) {
    ...
    var visibleLabels = g.nodes().slice(0) // CUSTOM
    visibleLabels.sort(function(a,b){ // CUSTOM
        return g.getNodeAttribute(a, "size")-g.getNodeAttribute(b, "size")
    })
    ...
    visibleLabels.forEach(function(nid){
      ...
      */
      ...
      var fontWeight = sw[1]
      ctx.font = ns.buildContextFontString(
        500,// CUSTOM // fontWeight, 
        fontSize,
        options.label_font_family
      )
