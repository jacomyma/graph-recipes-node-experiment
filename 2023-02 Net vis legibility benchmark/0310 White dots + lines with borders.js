...
const filename = "0310 White dots + lines with borders"
...
settings.node_stroke_width = 0.4
      ...
      g.edges()
        ...
        .forEach(function(eid, i_){
          ...
          for (i=0; i<path.length; i+=3) {
            ...
            if (lastx) {
              ctx.lineWidth = 2 * thickness * (0.9 + 0.2*Math.random())
