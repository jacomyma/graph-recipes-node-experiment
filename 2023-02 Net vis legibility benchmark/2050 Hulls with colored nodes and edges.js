...
const filename = "2050 Hulls with colored nodes and edges"
...
let targetL = d3.hcl("#707070").l // Custom (fix lightness)
g.nodes().forEach(nid => {
...
newRenderer = function(){
  ...
  ns.drawEdgesLayer = function(options) {
    ...
    let targetL = d3.hcl("#999999").l // Custom (fix lightness)
