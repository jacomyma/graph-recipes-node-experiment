...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/06 3 big modules.gexf', 'utf8');
...
settings.node_size = .9 // Factor to adjust the nodes drawing size
...
settings.heatmap_spreading = settings.image_width / 180 // in mm
