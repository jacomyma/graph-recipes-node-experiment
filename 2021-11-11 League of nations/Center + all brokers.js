...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/LeagueOfNations.gexf', 'utf8');
...
settings.image_width = 297 // in mm. Default: 200mm (fits in a A4 page)
settings.image_height = 210
...
g.nodes().forEach(nid => {
  ...
  if (n['supergroup'] == 'center' || n['cat1']=='IICI' || n['cat1']=='SECRS' || n['cat1']=='SECRG') {
    n.hide = false
  } else {
    n.hide = true
  }
          ...
          if (options.edge_high_quality) {
            ...
            for (pi=0; pi<path.length; pi+=3) {
              ...
              if (dpixi === undefined) {
                ...
                if (vidPixelMap_u[pixi] == n_s.vid || vidPixelMap_u[pixi] == n_t.vid || hiddenNodes[vidPixelMap_u[pixi]]) {
                  o = 1
                } else {
