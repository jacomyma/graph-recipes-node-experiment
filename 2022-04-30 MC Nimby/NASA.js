...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/03 giant component.gexf', 'utf8');
...
// Layer: Background
settings.background_color = "#f9f4e1"
...
settings.hillshading_color = "#4389dd"
...
settings.hillshading_hypsometric_gradient_colors = ['#000000', '#697f7d', '#c0c98d', '#FFFFFF']
...
g.nodes().forEach(nid => {
  ...
  n.showLabel = n.attr_type == "Author Keywords"
})
