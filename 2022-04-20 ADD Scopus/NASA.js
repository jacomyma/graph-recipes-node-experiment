...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/Scopus_WithAlgoLabels mod.gexf', 'utf8');
...
settings.margin_top    = 40 // in mm
settings.margin_right  = 100 // in mm
settings.margin_bottom = 120 // in mm
settings.margin_left   = 100 // in mm
...
// Layer: Edges
settings.edge_thickness = .18 // in mm
...
settings.node_size = .7 // Factor to adjust the nodes drawing size
...
settings.heatmap_spreading = settings.image_width / 200 // in mm
