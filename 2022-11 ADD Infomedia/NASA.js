...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/infomedia - respat.gexf', 'utf8');
...
let wiggleMargin = 100
settings.image_width = 841+2*wiggleMargin // in mm. Default: 200mm (fits in a A4 page)
settings.image_height = 1189+2*wiggleMargin
...
settings.margin_top    = wiggleMargin + 24 // in mm
settings.margin_right  = wiggleMargin + 24 // in mm
settings.margin_bottom = wiggleMargin + 24 // in mm
settings.margin_left   = wiggleMargin + 24 // in mm
...
settings.edge_alpha = .5 // Opacity // Range from 0 to 1
...
settings.node_size = 0.95 // Factor to adjust the nodes drawing size
...
settings.node_stroke_width = 0.05 // mm
...
// Experimental stuff
settings.hillshading_strength = 50
