...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/gephi.gexf', 'utf8');
...
settings.image_width = 2000 // in mm. Default: 200mm (fits in a A4 page)
settings.image_height = 1220
...
// Misc.
settings.pen_size = 0.10 // Manga frame line: 0.5; Thinnest draw pen: 0.03

// Layer: Background
settings.background_color = "#003366"

// Layer: Connected-closeness
settings.cc_text_color = "#ffffff"
settings.cc_text_border_color = "#003366"
settings.cc_font_size = 8 // in pt
settings.cc_line_color = "#ffffff"
settings.cc_grid_line_color = "#ff2557"
...
settings.node_size = 0.36 // Factor to adjust the nodes drawing size
settings.node_stroke_color = "#ffffff"
settings.node_fill_color = "#003366"

// Layer: Node labels
settings.label_color = "#ffffff"
settings.label_max_length = 96 // Number of characters before truncate. Infinity is a valid value.
settings.label_font_min_size = 3 // in pt
settings.label_font_max_size = 8  // in pt
settings.label_font_thickness = .128
settings.label_border_thickness = .7 // in mm
settings.label_spacing_offset = .7 // in mm (prevents label overlap)
...
settings.voronoi_resolution_max = 5 * Math.pow(10, 7) // in pixel. 10^7 still quick, 10^8 better quality 
...
settings.hillshading_color = "#340093"
