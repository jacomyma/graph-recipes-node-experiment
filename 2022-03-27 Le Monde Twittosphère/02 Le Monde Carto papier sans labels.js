...
settings.margin_top    = 100 // in mm
settings.margin_right  = 200 // in mm
settings.margin_bottom = 100 // in mm
settings.margin_left   = 200 // in mm

// Image size and resolution
settings.image_width = 630 + settings.margin_left + settings.margin_right // in mm. Default: 200mm (fits in a A4 page)
settings.image_height = 470 + settings.margin_top + settings.margin_bottom
...
newRenderer = function(){
  ...
  ns.drawNodeLabelsLayer = function(options) {
    ...
    // Draw text
    // Custom: do not draw the labels (separate layer)
    /*labelsStack.forEach(function(l){
      ctx.font = l.font
      ctx.lineWidth = 0
      ctx.fillStyle = l.color.toString()
...
renderer.renderAndSave(g, settings, 'Carto papier sans labels') // Custom
