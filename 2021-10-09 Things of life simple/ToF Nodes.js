...
settings.margin_top    =  64 // in mm
settings.margin_right  =  64 // in mm
settings.margin_bottom =  64 // in mm
settings.margin_left   =  64 // in mm
...
settings.node_size = 0.4 // Factor to adjust the nodes drawing size
settings.node_color_original = false // Use the original node color
settings.node_stroke_color = "#fff"
settings.node_fill_color = "#000"
