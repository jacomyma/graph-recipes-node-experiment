...
settings.node_size = 1.2 // Factor to adjust the nodes drawing size
...
settings.heatmap_spreading = (settings.image_width - settings.margin_left - settings.margin_right) / 64 // in mm

// Experimental stuff
settings.hillshading_strength = 120
...
fs.createReadStream('data/users_Trogneux_polemic.csv')
  ...
  .on('end', () => {
    ...
    renderer.renderAndSave(g, settings, 'Alt heatmap') // Custom
  });
