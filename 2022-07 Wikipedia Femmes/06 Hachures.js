...
// Experimental stuff
settings.hillshading_strength = 25 // Elevation factor
settings.hillshading_color = "#666666" //"#4f432f"
settings.hillshading_stroke_density_max = 2
...
newRenderer = function(){
  ...
  ns.drawHillshadingLines = function(options) {
    ...
    options.hillshading_stroke_density_max = 2 // in strokes per mm
...
renderer.renderAndSave(g, settings, "06 Hachures")
