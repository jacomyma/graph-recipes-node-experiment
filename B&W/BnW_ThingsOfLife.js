...
settings.output_dpi = 1200 // Dots per inch.
settings.rendering_dpi = 1200 // Default: same as output_dpi. You can over- or under-render to tweak quality and speed.
...
// Layer: Hillshading
settings.hillshading_strength = 20
settings.hillshading_color = "#000000"
settings.hillshading_alpha = .25 // Opacity
settings.hillshading_sun_azimuth = Math.PI * 0.666 // angle in radians
settings.hillshading_sun_elevation = Math.PI * 0.333 // angle in radians

// Layer: Connected-closeness
settings.cc_text_color = "#000000"
settings.cc_text_border_color = "#ffffff"
settings.cc_font_size = 8 // in pt
settings.cc_line_color = "#000000"
settings.cc_grid_line_color = "#000000"
...
settings.cluster_node_size_margin = 5 // In mm
...
settings.cluster_fill_color_default = "#eeeeee"
settings.cluster_fill_overlay = true // A different blending mode
// ...cluster contours
settings.cluster_contour_thickness = .5 // Range: 0 to 10 or more
...
settings.cluster_contour_color_default = "#000000"
// ...cluster labels
...
settings.label_border_thickness = .9 // in mm
settings.label_spacing_offset = 1.5 // in mm (prevents label overlap)
settings.label_border_color = settings.background_color
settings.label_spacing_factor = 1 // 1=normal; 2=box twice as wide/high etc.
settings.label_spacing_offset = .3 // In mm
...
settings.heatmap_spreading = 6 // in mm
...
newRenderer = function(){
  ...
  ns.drawNodeLabelsLayer = function(options) {
    ...
    options.label_spacing_factor = options.label_spacing_factor || .8 // 1=normal; 2=box twice as wide/high etc.
