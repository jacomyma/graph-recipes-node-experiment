...
var gexf_string;
try {
    gexf_string = fs.readFileSync('data/01 Rotated.gexf', 'utf8');
...
settings.margin_top    = 16 // in mm
settings.margin_right  = 32 // in mm
settings.margin_bottom = 16 // in mm
...
// Layer: Background
settings.background_color = "#303040"
...
// Experimental stuff
settings.hillshading_strength = 6
settings.hillshading_color = "#001122"
settings.hillshading_alpha = .50 // Opacity
...
settings.hillshading_hypsometric_gradient_domain = [0,         0.15,      0.30,      0.60,      0.75,      1]
settings.hillshading_hypsometric_gradient_colors = ['#304040', '#102020', '#000000', '#1E1C1C', '#473F3A', '#5B5147']
