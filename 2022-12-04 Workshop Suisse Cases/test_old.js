...
settings.node_size = 1.0 // Factor to adjust the nodes drawing size
...
g.nodes().forEach(nid => {
  ...
  let modality = settings.node_clusters.modalities[n[settings.node_clusters.attribute_id]]
  if (modality) {
    n.color = modality.color || settings.node_clusters.default_color
  } else {
