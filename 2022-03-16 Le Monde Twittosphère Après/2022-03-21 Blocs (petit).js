...
let blocs = [
  "Autres",
  "Comptes peu influents de la droite, de l’extrême droite et antisystèmes",
  "Comptes de la gauche et de l’extrême gauche",
  "Comptes de la droite et l’extrême droite",
  "Comptes du centre, de la droite, et du gouvernement",
  "Divers comptes influents",
  "Autorités de la droite et de l’extrême droite",
  "Autorités antisystèmes",
  "Acteurs majeurs 2 : Jadot, Le Pen, autres",
  "Acteurs majeurs 1 : Macron, Mélenchon, Pécresse, Zemmour",
  "Acteurs majeur : Philippot"
]
blocs.forEach(bloc => {
  g.nodes().forEach(nid => {
    let n = g.getNodeAttributes(nid)
